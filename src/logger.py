...
class Log(object):
    ...
    __logger_info_template = {"Info": "", "Info Location": "", "Time": "", "Version number": ""}
    ...
    def log_error(
        self, error_number: int, error_message: str, error_location: str, error_object: Exception, additional_data: str
    ) -> None:
        """
